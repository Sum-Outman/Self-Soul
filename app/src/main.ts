...
// Import configuration manager plugin
import configPlugin from './utils/config/configPlugin.js'

// Ensure DOM is fully loaded before mounting the application
document.addEventListener('DOMContentLoaded', () => {
    try {
      ...
      app.use(configPlugin) // Add configuration manager plugin
      app.use(pinia)
